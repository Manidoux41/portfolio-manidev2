  ...
  return (
    <div>
        <div>
            <div>
                <p>Contact</p>
                <p>Submit the form bellow to get in touch with me</p>
            </div>
            ...
            <div>
                <form action="">
                    ...
                    <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>
                        Let's tal
                    </button>
                </form>
            </div>
